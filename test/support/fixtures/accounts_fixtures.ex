defmodule AlbertAirline.AccountsFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `AlbertAirline.Accounts` context.
  """
  ...
  def generate_user_magic_link_token(user) do
    ...
    AlbertAirline.Repo.insert!(user_token)
