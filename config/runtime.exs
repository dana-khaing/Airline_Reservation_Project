...
#
#     PHX_SERVER=true bin/albert_airline start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :albert_airline, AlbertAirlineWeb.Endpoint, server: true
end
  ...
  config :albert_airline, AlbertAirlineWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/albert_airline_web/router\.ex$"E,
        ~r"lib/albert_airline_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
...
if config_env() == :prod do
  ...
  config :albert_airline, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
